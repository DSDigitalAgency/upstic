  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-700">Browse and apply for healthcare positions that match your skills</p>
      </div>
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="relative flex-1">
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black placeholder-gray-500"
            />
        ...
        <div className="mt-3">
          <span className="text-sm font-medium text-gray-700">{jobs.length} jobs found</span>

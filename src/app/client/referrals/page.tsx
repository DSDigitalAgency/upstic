  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Refer other healthcare facilities and earn bonuses</p>
      </div>
      ...
      <div className="mb-6">
        <nav className="flex space-x-8">
          {[
            { id: 'refer', label: 'Refer Facilities' },
          ...
          <div className="bg-white rounded-lg shadow-md">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Refer a Healthcare Facility</h3>
                <button
              ...
              <div className="p-6 border-b border-gray-200">
                <form onSubmit={handleSubmitReferral} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="referredRole" className="block text-sm font-medium text-gray-700 mb-1">
                        Refer as
                      </label>
                      <select
                        id="referredRole"
            ...
            {!showReferralForm && (
              <div className="p-6 text-center text-gray-500">
                ...
                <p className="mt-1 text-sm text-gray-500">Click &quot;New Referral&quot; to invite a healthcare facility.</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Invite healthcare facilities via email with a personal message</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-green-600 font-bold text-lg">2</span>
                </div>
                <h4 className="font-medium text-gray-900 mb-2">Facility Registers</h4>
                <p className="text-sm text-gray-600">The facility signs up using your referral link</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Get £100 when they post their first job</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  referrals.map((referral) => (
                    <tr key={referral.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button
                          onClick={() => referral.referralCode && copyReferralLink(referral.referralCode as string)}
